...
+ This is a 'wide' version, also has the Angle mod 
...
; 'wide' version, # % moved to ]
AddMappings(1, 1,        ' q w e r t  u i o p [ ',       ' Q Y O U @     B M R C Z ')
AddMappings(1, 1,        " a s d f g  j k l `; ' ",      ' ~ I E A J     W T N S K ') 
AddMappings(1, 1, '@LShift z x c v b  m , . /  @RShift', ' | P ^ G \ \   V D L F X ')

; main
AddMappings(1, 0,        ' q w e r t  u i o p [ ]',       ' q y o u }     b m r c z #')
AddMappings(1, 0,        " a s d f g  j k l `; ' ",       " ' i e a j     w t n s k ")
AddMappings(1, 0, '@LShift z x c v b  m , . /  @RShift',  ' { p : g _ _   v d l f x ')
...
AddMappings(2, 0, '@LShift z x c v b  m , . /  @RShift',  '  8 4 0 2 6 :   9 3 1 5 7   ')
