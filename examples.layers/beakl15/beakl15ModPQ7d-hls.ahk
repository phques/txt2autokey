/* modified BEAKL15 PQ7d, 'half LaSalle'
...
global ImgsDir := A_ScriptDir . "\imgs\modPQ7dHLS"
global ImgWidth := 218
global ImgHeight := 74
...
AddMappings(1, 1, 'q w e r    i o p [  ',   ' Q I E U    C R F Z ')
AddMappings(1, 1, "a s d f  j k l `; ' ",   ' Y H O A  M S T N B ') 
...
AddMappings(1, 0, 'q w e r      i o p [  ',  ' q i e u      c r f z ')
AddMappings(1, 0, "a s d f    j k l `; ' ",  ' y h o a    m s t n b ')
