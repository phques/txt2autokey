...
global ImgsDir := A_ScriptDir . "\imgs\BEAKL15modPQ4"
global ImgWidth := 200
global ImgHeight := 62
...
AddMappings(1, 1, " a s d f   j k l `; ' ",  ' Y I E A  S T N B `; ') 
AddMappings(1, 1, ' z x c v   m , . /    ',  ' J ! ? K  M L P V    ')
...
AddMappings(1, 0, " a s d f      j k l `; ' ",  ' y i e a      s t n b `; ')
AddMappings(1, 0, ' z x c v      m , . /    ',  " j , / k      m l p v    ")
...
AddMappings(2, 0, "- a s d f g  h j k l `; ' ", ' - \ ( . ) #     $ { d } | `; ')
AddMappings(2, 0, '  z x c v b    m , . /    ', "   * - x ' !       g w + &    ")
